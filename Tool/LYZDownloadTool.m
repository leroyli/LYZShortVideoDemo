...
@implementation LYZDownloadTool

static LYZDownloadTool* _instance = nil;
...
{
    if (url == nil) {return;}
    [LYZDownloadTool shareInstance].progressView = [[SDPieProgressView alloc] init];
    ...
    NSURLSessionDownloadTask *downloadTask = [manager downloadTaskWithRequest:request progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        [LYZDownloadTool shareInstance].progressView.progress = progress;
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [[LYZDownloadTool shareInstance].progressView dismiss];
            if (compeletionBlock) {
                compeletionBlock();
            }
        });
